...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-blue-th text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-blue-th transition'
