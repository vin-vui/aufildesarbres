                ...
                <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12" x-data="{ active: 'p1' }">
                    ...
                    <form x-show.transition.in.opacity.duration.500ms="active === 'p2'" action="{{ route('contact') }}" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <input required id="institution" name="institution" type="text" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-green-th focus:border-green-th border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div>
                            <div class="flex justify-between">
                            ...
                            <div class="mt-1">
                                <input required id="count_people" name="count_people" type="number" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-green-th focus:border-green-th border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div>
                            <label for="count_accompanist" class="block text-sm font-medium text-gray-900">Nombre d'accompagnateurs</label>
                            <div class="mt-1">
                                <input id="count_accompanist" name="count_accompanist" type="number" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-green-th focus:border-green-th border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div>
                            <label for="date_arrival" class="block text-sm font-medium text-gray-900">Heure d'arrivée</label>
                            <div class="mt-1">
                                <input type="datetime-local" name="date_arrival" id="date_arrival" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-green-th focus:border-green-th border-gray-300 rounded-md" aria-describedby="date-optional">
                            </div>
                        </div>
                        <div>
                            <label for="date_departure" class="block text-sm font-medium text-gray-900">Heure de départ</label>
                            <div class="mt-1">
                                <input type="datetime-local" name="date_departure" id="date_departure" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-green-th focus:border-green-th border-gray-300 rounded-md" aria-describedby="date-optional">
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            <div class="flex justify-between">
